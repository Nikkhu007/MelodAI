...
async function getCachedAudioUrl(videoId) {
  ...
  const cmd = `yt-dlp --extractor-args "youtube:player_client=android" "https://www.youtube.com/watch?v=${videoId}" --get-url --format "bestaudio" --no-playlist --no-warnings --quiet`
