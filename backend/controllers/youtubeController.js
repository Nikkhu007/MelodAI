...
async function getCachedAudioUrl(videoId) {
  ...
  const cmd = `yt-dlp --cookies ./cookies.txt --extractor-args "youtube:player_client=android" "https://www.youtube.com/watch?v=${videoId}" --get-url --format "bestaudio/best" --no-playlist --no-warnings --quiet`
